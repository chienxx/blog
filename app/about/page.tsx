...
const Tag = ({ type }: { type: ChangeType }) => {
  ...
  return (
    <span className={`mr-3 inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${tagConfig.bgClass} transition-all duration-200 hover:scale-105`}>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
            <div className="md:col-span-7">
              <div className="relative">
                {/* 时间轴线 */}
                <div className="absolute left-8 top-0 h-full w-0.5 bg-gray-300 dark:bg-gray-600"></div>
                ...
                <div className="space-y-12">
                  {changelog.map((release, index) => (
                    <div key={index} className="relative group">
                      {/* 时间节点 */}
                      <div className="absolute left-8 top-5 -ml-4 h-8 w-8 rounded-full border-2 border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900 transition-all duration-300 group-hover:border-primary-500 group-hover:scale-110 flex items-center justify-center">
                        <span className="text-xs font-bold text-gray-400 dark:text-gray-600 group-hover:text-primary-500 transition-colors duration-300">
                          {index + 1}
                        </span>
                      </div>
                      ...
                      <div className="ml-20 transform transition-all duration-300 group-hover:translate-x-1">
                        ...
                        <ul className="mt-4 space-y-4">
                          {release.changes.map((change, changeIndex) => (
                            <li key={changeIndex} className="flex items-start p-2 rounded-lg transition-all duration-200 hover:bg-gray-50 dark:hover:bg-gray-800/50">
            ...
            <div className="md:col-span-5">
              <div className="sticky top-8 space-y-8">
                {/* 版本说明卡片 */}
                <div className="rounded-lg bg-gray-50 p-6 dark:bg-gray-800/50 shadow-sm hover:shadow-md transition-shadow duration-300">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="mt-2 space-y-2">
                        {Object.entries(tagTypeMap).map(([type, config]) => (
                          <div key={type} className="flex items-center p-1.5 rounded transition-colors duration-200 hover:bg-gray-100 dark:hover:bg-gray-700/50">
                    ...
                    <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                      ...
                      <div className="mt-2 grid grid-cols-3 gap-4 text-center">
                        <div className="rounded-md bg-white p-3 dark:bg-gray-700 shadow-sm hover:shadow transition-shadow duration-200">
