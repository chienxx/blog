...
const InteractiveCard = ({ title, description, imgSrc, href, label }) => (
  <GradientBorder
    offset={28}
    className="flex transform flex-col rounded-[20px] bg-zinc-50 p-4 transition-transform duration-300 ease-in-out hover:scale-105 md:p-6 dark:bg-white/5 dark:shadow-none"
  >
    ...
    <div className="mb-4 flex items-center gap-4">
      ...
      <div className="flex flex-col items-start gap-1 pt-1">
        <h2 className="text-[20px] leading-[28px] font-bold">
          {href ? (
